# learn_80_closures_iterators — Closures & Iterators
...
| --- | --- | --- | --- |
| 01 | `learn_80_01_closures` | closures, capture, `move`, `impl Fn` | arrow functions |
| 02 | `learn_80_02_iterators` | `map`/`filter`/`fold`/`collect` | JS array methods |
