...
```bash
cargo run --bin proj_10_cli_todo -- add "buy milk"
cargo run --bin proj_10_cli_todo -- add "write rust"
cargo run --bin proj_10_cli_todo -- list
cargo run --bin proj_10_cli_todo -- done 1
cargo run --bin proj_10_cli_todo -- remove 2
```
