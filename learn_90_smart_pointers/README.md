# learn_90_smart_pointers — Box, Rc, RefCell, Arc
...
| # | Binary | Type | Use for |
| --- | --- | --- | --- |
| 01 | `learn_90_01_box` | `Box<T>` | single owner, heap, recursive types |
| 02 | `learn_90_02_rc_refcell` | `Rc<T>`, `RefCell<T>` | shared ownership + runtime-checked mutation |
| 03 | `learn_90_03_arc` | `Arc<T>`, `Mutex<T>` | shared state across threads |
